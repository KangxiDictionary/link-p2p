...
pub async fn run_tun_phone(
    ...
    // Local TUN → active peer by destination VIP.
    {
...
async fn phone_run_peer(
    ...
    let peer_vip = exchange_peer_vip(&conn, own_vip, dialer).await?;
